  ...
  return (
    <footer className="bg-gray-100 text-gray-800 py-8 ">
      <div className="max-w-screen-lg mx-auto px-4 sm:px-6 md:flex md:justify-between font-serif">
        <div className="mb-6 md:mb-0 font-serif">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 font-serif">
          <div>
      ...
      <p className="text-center text-sm text-gray-500 mt-4 font-serif">&copy; {new Date().getFullYear()} Japan Bangladesh Advisory. All rights reserved.</p>
    </footer>
  );
};
