      ...
      <div className="lg:mt-[-16rem] grid max-w-7xl px-10 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="max-w-2xl mb-6 font-light font-serif text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 text-justify">
            Japan Bangladesh Advisory (JBA) is a premier consultancy firm
            dedicated to facilitating seamless business operations between Japan
            and Bangladesh. With a strong commitment to professionalism,
            efficiency, and cultural integration, we provide comprehensive
            services, including visa processing, expat management, recruitment,
            business setup, rent-a-car services, hotel booking, and Japanese
            language training. Our expertise in cross-border business operations
            ensures smooth market entry, regulatory compliance, and sustainable
            growth for foreign companies looking to establish or expand in
            Bangladesh.
          </p>
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
          <img src={gif_1} alt="Speak to an Expert" />
        </div>
      </div>
    </section>
  );
