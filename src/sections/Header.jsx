...
const navItems = [
  ...
  { label: "About Us", type: "scroll", to: "about" },
  {
    ...
    to: "services",
    children: [
      { label: "VISA Services", to: "/visa", type: "router" },
      { label: "Business Setup", to: "/services#business", type: "router" },
      { label: "Expat Management", to: "/services#expat", type: "router" },
      { label: "Travel & Hospitality", to: "/services#travel", type: "router" },
    ],
  },
