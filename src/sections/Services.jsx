...
const Services = () => {
  return (
    <section className="container relative flex flex-col justify-between h-full max-w-7xl px-10 mx-auto xl:px-0 mt-10 text-center">
      {/* Title & Description */}
      <h2 className="mt-10 mb-5 text-3xl font-extrabold text-gray-900">Our Services</h2>
      <p className="lg:mx-12 md:mx-8 mb-6 md:text-lg lg:text-xl text-gray-500 dark:text-gray-400 font-serif text-justify">
        ...
        for expatriates, professionals, and businesses, providing expert guidance
        in the Japanese and Bangladeshi markets.
      </p>
        ...
        {servicesData.map((service, index) => (
          ...
          >
            ...
            <div className="md:w-[50%] w-full bg-gradient-to-r from-purple-600 to-pink-600 shadow-lg p-8 md:p-4 rounded-md ">
              ...
              <p className="lg:text-lg md:text-sm mt-4 mb-4 px-4 font-serif font-medium text-justify text-white">{service.description}</p>
            </div>
          </div>
        ))}
      </div>
